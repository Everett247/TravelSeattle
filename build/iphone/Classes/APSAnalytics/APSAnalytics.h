 ...
 * to send analytic data that can be viewed on the EverettsInterface Dashboard.
 *
 * For information on getting started with EverettsInterface Platform Services,
