...
@interface EverettsInterfaceObject : KrollCoverageObject {
#else
@interface EverettsInterfaceObject : KrollObject {
#endif
@private
...
extern NSString * EverettsInterface$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	EverettsInterfaceObject *_everettsinterface;
    KrollObject* console;
	BOOL shutdown;
