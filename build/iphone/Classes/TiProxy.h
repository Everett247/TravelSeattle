...
//Rare exceptions to indicate a bug in the _everettsinterface code (Eg, function that a subclass should have implemented)
...
/**
 The base class for EverettsInterface proxies.
 */
