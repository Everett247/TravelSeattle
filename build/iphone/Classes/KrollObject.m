...
//@interface EverettsInterfaceObject : NSObject
//@end

@interface EverettsInterfaceObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[EverettsInterfaceObject class]])
		{
			for (NSString *key in [[(EverettsInterfaceObject*)o modules] allKeys])
			{
