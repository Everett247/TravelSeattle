...
/**
 Base class for all EverettsInterface views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the EverettsInterface view hierarchy (such as wrapped iOS UIViews) was touched.
