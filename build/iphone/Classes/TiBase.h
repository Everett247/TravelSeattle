...
// in simulator we redefine to format for EverettsInterface Developer console
...
{\
	NSString * exceptionName = [@"org.everettsinterface." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.everettsinterface";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIEverettsInterfaceNativeItemNone = -1, 
	UIEverettsInterfaceNativeItemSpinner = -2,
	UIEverettsInterfaceNativeItemProgressBar = -3,
	
	UIEverettsInterfaceNativeItemSlider = -4,
	UIEverettsInterfaceNativeItemSwitch = -5,
	UIEverettsInterfaceNativeItemMultiButton = -6,
	UIEverettsInterfaceNativeItemSegmented = -7,
	
	UIEverettsInterfaceNativeItemTextView = -8,
	UIEverettsInterfaceNativeItemTextField = -9,
	UIEverettsInterfaceNativeItemSearchBar = -10,
	
	UIEverettsInterfaceNativeItemPicker = -11,
	UIEverettsInterfaceNativeItemDatePicker = -12,
	
	UIEverettsInterfaceNativeItemInfoLight = -13,
	UIEverettsInterfaceNativeItemInfoDark = -14,
	
	UIEverettsInterfaceNativeItemDisclosure = -15,
	
	UIEverettsInterfaceNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all EverettsInterface instances of
